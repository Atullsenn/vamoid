...
// paginaiton
    ...
    const GetApplicationData = async()=>{
        ...
        await axios.post(URL + '/merchant/getappuserdata',reqq,{
    ...
    function generateRandomString(length) {
        var result           = '';
        var characters       = 'ABCDEFGHAGDHQBNMLKOIUIUGQWAOIYIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvkjshdkjfwxyz01234567892487198712332';
    ...
    const createapplication = async(res)=>{
        ...
        await axios.post( URL + '/merchant/create-application',{
            'user_id': localStorage.getItem('superAdminId'),
            ...
            toast.warn('Application Created Successfully')
            //console.log(res)
    ...
    const applicationDelete = async(th)=>{
        await axios.post( URL + '/merchant/application-delete',{id:th}).then((res)=>{
          GetApplicationData()
            //console.log(res)
        }).catch((err)=>{
            console.log(err)
    ...
    return (
      ...
      <div style={{ padding: "24px" }}>
         {applicationList.length === 0 ? (<div style={{position:'absolute',left:'50%',top:'30%', color: 'pink'}}><CircularProgress disableShrink /></div>) : ''}
        <Modal show={isOpen}>
          <Modal.Header>
            <button
              type="button"
                          ...
                          return (
                            <tr>
                              ...
                              <td>
                                <div className="user-icon-detail-area">
                                  ...
                                  <div className="user-name-area">
                                    <h5>
                                      <Link
                                        to={`/app/admin/application-activity-setup/${app.id}`}
                                      >
                              ...
                              <td>
                                ...
                                <button type="button" className="subscription-plan-custmize-btn" onClick={()=>{handleStatus(app.status,app.id)}}>{app.status == 1 ? 'Active' : 'Inactive'}</button>
                              </td>
                            </tr>
                          );
                        })}
